                                    ...
                                    <div id="home" class="container tab-pane active">
                                        <div class="form-inputs pt-5 pb-5">
                                            <div class="riskfactors">
                                                ...
                                                <label class="checking">Sickle Cells
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Fibroids
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">PID (Pelvic Inflammatory Disease)
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Severe Migrane
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Heart Disease
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Thrombosis/Stroke
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Hepatitis
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Gall Bladder Condition
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Breast Disease
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Depression
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Allergies
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Infertility
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Asthma
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Epilepsy
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Contact Lenses
                                                    <input type="checkbox" >
                                                    <span class="checkmark"></span>
                                                </label>
                                                <label class="checking">Contraceptive Complication (Specify)
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                ...
                                                <label class="checking">Other (Specify)
                                                    <input type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                                <div class="form-group">
