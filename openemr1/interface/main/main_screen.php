...
<?php } else {
    ...
    // use tall nav area ?>
 <div id="app">
<frameset cols='<?php echo attr($nav_area_width); ?>,*' id='fsbody' frameborder='0' noresize border='0' framespacing='4' onunload='imclosing()'>
 <frameset rows='*,0' frameborder='0' border='0' framespacing='0' noresize>
  <frame src='left_nav.php' name='left_nav' />
  <frame src='daemon_frame.php' name='Daemon' scrolling='no'  frameborder='0'
   border='0' framespacing='0' />
 </frameset>
 <frameset rows='<?php echo attr($GLOBALS['titleBarHeight']) + 5 ?>,*' frameborder='0' border='0' framespacing='1' noresize>
  <frame src='main_title.php' name='Title' scrolling='no' frameborder='1' />
  <frameset rows='*' id='fsright' bordercolor='#999999' frameborder='0' border='4' framespacing='4' noresize>
