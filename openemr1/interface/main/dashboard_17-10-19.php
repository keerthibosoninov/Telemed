                                ...
                                <div class="container-fluid">
                                    <div class="wrapper relative">
                                        <label for="datepicker">
                                            ...
                                            <img src="<?php echo $GLOBALS['assets_static_relative']; ?>/img/dropdown.svg" alt="" class="dropdown-calander">
                                        </label>
                                    </div>
                            ...
                            <window-dashboard title="Tasks">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row task-box">
                                        ...
                                        ?>
                                            <h5><?php echo date('G:i',strtotime($startdate)); ?>&nbsp;<?php echo text(date('a', $startdate)); ?></h5>
                                            <h5><?php echo date('d',strtotime($startdate)) ?></h5>
                                            <h6><?php echo date('D',strtotime($startdate)) ?></h6>
                                        </div>
