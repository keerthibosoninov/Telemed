                                        ...
                                        <div class="pt-4 pb-4">
                                            <div class="pt-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 relative">
                                                        <p>Discharge</p>
                                                        <input type="time" class="form-control" placeholder="Middle Name">
                                                        <img src="<?php echo $GLOBALS['assets_static_relative']; ?>/img/date.svg" class="date-time" alt="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p>Location</p>
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <p>Findings</p>
                                                        <textarea name="" id="" class="form-control mt-2" rows="4"></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7 pt-3">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <input type="text" class="form-control" value="Physical Therapy">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
