                ...
                <div class="row titleshadow">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="right-notify">
                            ...
                            <a href="">
                                <img src="<?php echo $GLOBALS['assets_static_relative']; ?>/img/mail.svg" alt="" />
                            </a>
                            <a href="">
                                <img src="<?php echo $GLOBALS['assets_static_relative']; ?>/img/user.svg" alt="" />
                            </a>
                            <span><?php echo text($res{"fname"}.' '.$res{"lname"}); ?></span>
                        </div>
                    </div>
                </div>
            </div>
