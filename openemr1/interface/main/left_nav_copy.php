...
<style type="text/css">
    ...
    .bgcolor2, .body_nav {
    background-color: rgb(61, 161, 197);
}
   .navigation {
  width: 200px;
}
...
.submenu {
  ...
  -webkit-transition: all 0.5s ease-out;
    ...
    /*  custom by km for removing double colur of ul li */
        .parent-menu {
...
<center>
<select name='sel_frame' style='display:none; background-color:transparent;font-size:9pt;width:100;'>
...
<table style="display:none;" cellpadding='0' cellspacing='0' border='0' width='100%'>
 <tr>
 ...
 <ul class="parent-menu">
    ...
    <?php   genTreeLink('RTop', 'dash', xl('Dashboard')); ?>
