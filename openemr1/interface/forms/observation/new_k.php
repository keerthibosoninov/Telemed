        ...
        <section>
            <div class="body-content body-content2">
                <div class="container-fluid pb-4 pt-4">
                    <window-dashboard title="Observation" class="icon-hide">
                                        ...
                                        foreach ($check_res as $key => $obj) { ?>
                                            <div class = "tb_row" id="tb_row_<?php echo attr($key) + 1; ?>">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <p>Date</p>
                                                        <input type='text' id="code_date_<?php echo attr($key) + 1; ?>" name='code_date[]' class="form-control code_date datepicker" value='<?php echo attr($obj{"date"}); ?>' title='<?php echo xla('yyyy-mm-dd Date of service'); ?>' />                                                    </div>
...
<script>
$(function() {
    $("#observbtn").bind("click", function() {
        console.log("fgf")
        var div = $("<div class='bodypart9' />");
        div.html(GetDynamicTextBox9(""));
        $("#TextBoxContainer9").append(div);
        makeTextboxEditable();
        
    });
    $("body").on("click", ".remove9", function() {
        $(this).closest(".bodypart9").remove();
    });
});
...
<div class="row mt-3">
    ...
    <textarea name="comments[]" id="comments_1" class="form-control comments active-text activatetextarea"  rows="3" ><?php echo text($obj{"observation"}); ?></textarea>
    <img src="<?php echo $GLOBALS['assets_static_relative']; ?>/img/delete.svg" class="remove9" alt="">
    </div>
</div>`
}
