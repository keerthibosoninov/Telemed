...
if ($_POST['form_save']) {
    ...
    if ($issue) {
        ...
        "dosage ='"     . add_escape_custom($_POST['form_dosage'])     . "', " .
        "frequency ='"     . add_escape_custom($_POST['form_frequency'])     . "', " .
        "frequency_comments ='"     . add_escape_custom($_POST['form_frequency_comments'])     . "', " .
        ...
        "reaction, severity_al,dosage,frequency,frequency_comments, list_option_id " .
        ") VALUES ( " .
        "NOW(), " .
        ...
        "'" . add_escape_custom($_POST['form_dosage'])         . "', " .
        "'" . add_escape_custom($_POST['form_frequency'])         . "', " .
        "'" . add_escape_custom($_POST['form_frequency_comments'])         . "', " .
    ...
    <!-- <div class='tab current' style='height:auto;width:97%;'> -->
        ...
        <div>
            <form class="form-horizontal" name="<?php echo $form_name;?>" id="<?php echo $form_name;?>" method="post" >
                ...
                ?>
                <div class="row">
                    <div class="col-md-12" id='row_titles'>
                    <p >Type</p>
                        <?php
                         $index = 0;
                        foreach ($ISSUE_TYPES as $key => $value) {
                        ...
                        ?>
                    <select name='form_titles' id='form_titles'  class= "form-control pt-3" multiple size='3' onchange='set_text()'></select>
                ...
                <div class="row hidedata">
                    <div class="col-md-12">
                        <p>Substance</p>
                        <input type="text" class="form-control" name='substance' value=''>
                    </div>
                </div>
                <div class="row">
                <div class="col-md-12">
                    <p for="title_diagnosis"><?php echo xlt('Medication Name'); ?>:</p>
                    <div class="col-xs-10">
                ...
                <div class="row pt-3">
                <div class="col-md-3">
                    <label for="form_begin"><?php echo xlt('Begin Date'); ?>:</label>
                   
                        <input type='date' class='datepicker form-control'  name='form_begin' id='form_begin'
                        value='<?php echo attr($irow['begdate']) ?>'>
                    
                </div>
                <div class="col-md-3" id='row_enddate'>
                    <label  for="form_begin"><?php echo xlt('End Date'); ?>:</label>
                  
                        <input type='date' class='datepicker form-control'  name='form_end' id='form_end'
                        value='<?php echo attr($irow['enddate']) ?>' />
                        <!-- (<?php echo xlt('leave blank if still active'); ?>) -->
                    
                </div>
                <div class="col-md-3">
                <p class="pt-5 fs-14">(Leave blank if still active)</p>
                    </div>
                    </div>
                ...
                <div class="col-md-4">
                <p>Dosage(mg)</p>
                <input type="text" name="form_dosage" id="form_dosage" value='<?php echo attr($irow['dosage']) ?>' class="form-control" >
                </div>
                <div class="col-md-4">
                <p>Frequency</p>
                <select name="form_frequency" id="form_frequency" class="form-control">
                    <option value="Once in a day" <?php if($irow['frequency']=="Once in a day") echo 'selected="selected"'; ?>>Once in a day</option>
                    <option value="Twice in a day" <?php if($irow['frequency']=="Twice in a day") echo 'selected="selected"'; ?>>Twice in a day</option>
                    <option value="Other" <?php if($irow['frequency']=="Other") echo 'selected="selected"'; ?>>Other</option>                                                                                                                   
                </select>
                </div>
                <div class="col-md-4">
                <p>Comments</p>
                <textarea name="form_frequency_comments" id="form_frequency_comments" class="form-control pt-3" rows="3"><?php echo text($irow['frequency_comments']) ?></textarea>
                </div>
                </div>
                <div class="row hidedata">
                ...
                <div class="row">
                    <div class="col-md-12" id='row_comments'>
                        ...
                        <div class="col-xs-10">
                        <textarea class="form-control pt-3" name='form_comments' rows="3" id='form_comments'><?php echo text($irow['comments']) ?></textarea>
                        </div>
                    </div>
                </div>
...
$(function() {
    ...
    $('#theform_medication').submit(function(e){
        e.preventDefault();
        // alert();
        $webroot="<?php echo $GLOBALS['webroot']?>";
        $.ajax({
            type: 'POST',
            url: $webroot+"/interface/patient_file/summary/add_issues_new_med.php",
            data: $('#theform_medication').serialize(),   
