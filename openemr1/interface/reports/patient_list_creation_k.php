                                        ...
                                        <div id="report_parameters" class="pt-4 pb-4">
                                            ...
                                            <div class="pt-4 pb-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2"> 
                                                        <button class="form-save" onclick='submitForm();$("#form_csvexport").val("");$("#form_refresh").attr("value","true");'>SEARCH</button>
                                                    ...
                                                    <div class="col-md-2">
                                                        <button onclick='$("#form_csvexport").attr("value","true");submitForm();' class="form-save">Export to CSV</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="table-div ">
                                                <table class="table table-form">
                                                    ...
                                                    if (sqlNumRows($result) > 0) {
                                                        ...
                                                        foreach ($patFinalDataArr as $patKey => $patDetailVal) { 
                                                            if($_POST['form_csvexport']){
                                                                echo '"' . oeFormatDateTime($patDetailVal['lists_date'], "global", true) . '",';
                                                                echo '"' . qescape($patDetailVal['lists_diagnosis']) . '",';
                                                                echo '"' . qescape($patDetailVal['lists_title']) . '",';
                                                                echo '"' . qescape($patDetailVal['patient_name']) . '",';
                                                                echo '"' . qescape($patDetailVal['patient_id']) . '",';
                                                                echo '"' . qescape($patDetailVal['patient_age']) . '",';
                                                                echo '"' . qescape($patDetailVal['patient_sex']) . '",';                        
                                                                echo '"' . qescape($patDetailVal['users_provider']) . '"' . "\n";
                                                    ...
                                                    foreach ($patFinalDataArr as $patKey => $labResInsideArr) {
                                                        ...
                                                        <?php
                                                            ...
                                                            echo '"' . oeFormatDateTime($labResInsideArr['procedure_result_date'], "global", true) . '",';
                                                            echo '"' . qescape($labResInsideArr['procedure_result_facility']) . '",';
                                                            if($labResInsideArr['procedure_result_units']){
                                                                echo '"' . generate_display_field(array('data_type'=>'1','list_id'=>'proc_unit'), $labResInsideArr['procedure_result_units']) . '",';
                                                            }else{
                                                                echo ',';
                                                            }
                                                           
                                                            echo '"' . qescape($labResInsideArr['procedure_result_result']) . '",';
                                                            echo '"' . qescape($labResInsideArr['procedure_result_range']) . '",';
                                                            echo '"' . qescape($labResInsideArr['procedure_result_abnormal']) . '",';
                                                            echo '"' . qescape($labResInsideArr['procedure_result_comments']) . '",'; 
                                                            echo '"' . qescape($labResInsideArr['procedure_result_document_id']) . '",';                        
                                                            echo '"' . qescape($labResInsideArr['patient_id']) . '"' . "\n";
                                                        }
                                                    }
                                                    if (!$_POST['form_csvexport']) {    
                                                    ?>
                                                ...
                                                <tbody>
                                                 ...
                                                 <?php }else{
                                                        ...
                                                        echo '"' . qescape($patDetailVal['patient_date']) . '",';
                                                        echo '"' . qescape($patDetailVal['patient_name']) . '",';
                                                        echo '"' . qescape($patDetailVal['patient_id']) . '",';
                                                        echo '"' . qescape($patDetailVal['patient_age']) . '",'; 
                                                        echo '"' . qescape($patDetailVal['patient_sex']) . '",';  
                                                        echo '"' . qescape($patDetailVal['users_provider']) . '",';                        
                                                        echo '"' . qescape($patDetailVal['communications']) . '"' . "\n";
                                            ...
                                            <?php
                                                ...
                                                foreach ($patFinalDataArr as $patKey => $patDetailVal) {
                                                    ...
                                                    <?php }else{
                                                        ...
                                                        echo '"' . qescape($patDetailVal['patient_age']) . '",'; 
                                                        echo '"' . qescape($patDetailVal['patient_sex']) . '",';  
                                                        echo '"' . qescape($patDetailVal['p_address']) . '",';  
                                                        echo '"' . qescape($patDetailVal['users_provider']) . '",';                        
                                                        echo '"' . qescape($patDetailVal['communications']) . '"' . "\n";
                                                    }
                                                }
