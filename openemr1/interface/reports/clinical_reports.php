                                    ...
                                    <div id="report_parameters_daterange"> <?php echo text(oeFormatDateTime($sql_date_from, "global", true)) .
                                        ...
                                        if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
                                            ...
                                            ?>
                                                ...
                                                <div class="table-div " id = "report_result">
                                        ...
                                        $pidarr = array();
                                            while ($row = sqlFetchArray($result)) { 
                                                if ($_POST['form_csvexport']) {
                                                    echo '"' . oeFormatShortDate($row['p_date']) . '",';
                                                    echo '"' . qescape($row['patient_name']) . '",';
                                                    echo '"' . qescape($row['patient_id']) . '",';
                                                    echo '"' . qescape($row['patient_age']) . '",';
                                                    if($row['patient_sex']){
                                                        echo '"' . qescape(generate_display_field(array('data_type'=>'1','list_id'=>'sex'), $row['patient_sex'])) . '",';
                                                    ...
                                                    echo '"' . qescape($row['users_provider']) . '"';
                                                    if (strlen($communication) > 0 || $_POST['communication_check'] == true) { 
                                                    echo ',"' . qescape($row['communications']) . '"'. "\n";
                                                    }else{
                                                        echo "\n";
                                                    }
                                                    ...
                                                    <td <?php
                                                        if (strlen($communication) == 0 || ($_POST['communication_check'] == true)) {
                                                            ?> colspan=5 <?php
                                                        } ?>> <?php echo text($row['users_provider']); ?>&nbsp;
                                                    </td>
                                                ...
                                                if (strlen($form_diagnosis) > 0 || $_POST['form_diagnosis_allergy'] == true || $_POST['form_diagnosis_medprb'] == true) {
                                                        ...
                                                        <?php
                                                            ...
                                                            echo '"' . xl('Diagnosis Date') . '",';
                                                            echo '"' . xl('Diagnosis') . '",';
                                                            echo '"' . xl('Diagnosis Name') . '"' . "\n";
                                                            echo '"' . oeFormatDateTime($row['lists_date'], "global", true) . '",';
                                                            echo '"' . qescape($row['lists_diagnosis']) . '",';
                                                            echo '"' . qescape($row['lists_title']) . '",';
                                                        }
                                                }
                                                ...
                                                if (strlen($form_drug_name) > 0 || $_POST['form_drug'] == true) {
                                                    ...
                                                    if ( !$_POST['form_csvexport']) {
                                                        ...
                                                        <tr>
                                                            <td><b><?php echo "#";
                                                            echo xlt('Prescription Report');?><b></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        echo '"' . oeFormatShortDate($row['prescriptions_date_modified']) . '",';
                                                        echo '"' . qescape($row['drug']) . '",';
                                                        echo '"' . qescape($rx_route) . '",';
                                                        echo '"' . qescape($row['dosage']) . '",';
                                                        echo '"' . qescape($rx_form) . '",';
                                                        echo '"' . qescape($rx_interval) . '",';
                                                        echo '"' . qescape($row['size']) . '",';
                                                        echo '"' . qescape($rx_units) . '",';
                                                        echo '"' . qescape($row['refills']) . '",';
                                                        echo '"' . qescape($row['quantity']) . '",';
                                                        echo '"' . qescape($row['ndc_number']) . '"' . "\n";
                                                    }
                                                } 
                                                ...
                                                if (strlen($form_lab_results) > 0 || $_POST['lab_results'] == true) {
                                                    ...
                                                    <tr>
                                                        <td ><b><?php echo "#";
                                                        echo xlt('Lab Results Report');?><b></td>
                                                    </tr>
                                                    <tr>
                                                        <td><b><?php echo xlt('Date'); ?></b></td>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo '"' . oeFormatShortDate($row['procedure_result_date']) . '",';
                                                        echo '"' . qescape($row['procedure_result_facility']) . '",';
                                                        echo '"' . qescape(generate_display_field(array('data_type'=>'1','list_id'=>'proc_unit'), $row['procedure_result_units'])) . '",';
                                                        echo '"' . qescape($row['procedure_result_result']) . '",';
                                                        echo '"' . qescape($row['procedure_result_range']) . '",';
                                                        echo '"' . qescape($row['procedure_result_abnormal']) . '",';
                                                        echo '"' . qescape($row['procedure_result_comments']) . '",';
                                                        echo '"' . qescape($row['procedure_result_document_id']) . '"' . "\n";
                                                    }
                                                }
                                                ...
                                                if ($type == 'Procedure') {
                                                    ...
                                                    if ( !$_POST['form_csvexport']) {
                                                        ...
                                                        <tr >
                                                            <td ><b><?php echo "#";
                                                                echo xlt('Procedure Report');?><b></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b><?php echo xlt('Date'); ?></b></td>
                                                    ...
                                                    <?php
                                                            ...
                                                            echo '"' . oeFormatShortDate($row['procedure_order_date_ordered']) . '",';
                                                            echo '"' . qescape($procedure_type_standard_code) . '",';
                                                            echo '"' . qescape($row['procedure_name']) . '",';
                                                            echo '"' . qescape($row['procedure_order_encounter']) . '",';
                                                            echo '"' . qescape(generate_display_field(array('data_type'=>'1','list_id'=>'ord_priority'), $row['procedure_order_order_priority'])) . '",';
                                                            echo '"' . qescape(generate_display_field(array('data_type'=>'1','list_id'=>'ord_status'), $row['procedure_order_order_status'])) . '",';
                                                            echo '"' . qescape($row['procedure_order_patient_instructions']) . '",';
                                                            echo '"' . qescape($row['procedure_order_activity']) . '",';
                                                            echo '"' . qescape($row['procedure_order_control_id']) . '"' . "\n";
                                                    }
                                                } 
                                                ...
                                                if ($type == 'Medical History') {
                                                    ...
                                                    <!-- Medical History Report Start-->
                                                        <tr>
                                                            <td ><b><?php echo "#";echo xlt('Medical History');?><b></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <?php
                                                            ...
                                                            echo '"' . xl('History Date') . '",';
                                                            echo '"' . xl('Tobacco') . '",';
                                                            echo '"' . xl('Alcohol') . '",';
                                                            echo '"' . xl('Recreational Drugs') . '"' . "\n";


                                                            echo '"' . oeFormatShortDate($row['history_data_date']) . '",';
                                                            echo '"' . qescape($his_tobac) . '",';
                                                            echo '"' . qescape($res) . '",';
                                                            echo '"' . qescape($resd) . '"' . "\n";
                                                    }
                                                }
                                                ...
                                                if ($type == 'Service Codes') {
                                                    ...
                                                    if ( !$_POST['form_csvexport']) {
                                                        ...
                                                        <tr>
                                                            <td colspan=11><b><?php echo "#"; echo xlt('Service Codes');?><b></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b><?php echo xlt('Date'); ?></b></td>
                                                            <td><b><?php echo xlt('Code');?></b></td>
                                                            <td><b><?php echo xlt('Encounter ID');?></b></td>
                                                            <td colspan=8><b><?php echo xlt('Code Text');?></b></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        echo '"' . oeFormatShortDate($row['date']) . '",';
                                                        echo '"' . qescape($row['code']) . '",';
                                                ...
                                                if (strlen($form_immunization) > 0) {
                                                    ...
                                                    <!-- Immunization Report Start-->
                                                        ...
                                                        <?php
                                                            ...
                                                            echo '"' . xl('Immunization Date') . '",';
                                                            echo '"' . xl('CVX Code') . '",';
                                                            echo '"' . xl('Vaccine') . '",';
                                                            echo '"' . xl('Amount') . '",';
                                                            echo '"' . xl('Administered Site') . '",';
                                                            echo '"' . xl('Notes') . '"' . "\n";


                                                            echo '"' . oeFormatShortDate($row['imm_date']) . '",';
                                                            echo '"' . qescape($row['cvx_code']) . '",';
                                                            echo '"' . qescape(text($row['imm_code_short'])." (".text($row['imm_code']).")") . '",';
                                                            if ($row["amount_administered"] > 0) {
                                                                echo '"' . qescape(text($row["amount_administered"]) . " " . generate_display_field(array('data_type'=>'1','list_id'=>'drug_units'), $row['amount_administered_unit'])) . '",';
                                                            } else {
                                                                echo '" ",';
                                                            }
                                                            echo '"' . qescape(generate_display_field(array('data_type'=>'1','list_id'=>'proc_body_site'), $row['administration_site'])) . '",';
